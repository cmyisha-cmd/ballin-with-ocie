...
function App() {
  ...
  if (apiStatus === "missing") {
    return (
      <div style={styles.error}>
        ❌ <strong>VITE_API_BASE</strong> is not set!<br />
        Please configure it in your Vercel/Render environment variables.
      </div>
    );
  }
  if (apiStatus === "offline") {
    return (
      <div style={styles.error}>
        ❌ Could not reach API at <code>{API_BASE}</code><br />
        Check backend deployment or CORS settings.
      </div>
    );
  }
