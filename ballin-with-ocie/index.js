...
const seed = { players: [], shooting: [], tickets: [], messages: [], teams: {A:[], B:[]} }
...
app.post('/api/register', async (req,res)=>{
  ...
  if(shooting){
    ...
    list.push({ id, name, score: 0, time: '00:00' })
...
// serve built frontend (if this repo is deployed as a single app)
